        ...
        <div className="w-full h-70 flex gap-x-4 items-center mx-5">
          ...
          {jobData.length > 0 ? (
            jobData.map((job, index) => (
              <div
                className={(index<=counter1+3 && index >= counter1) ? "h-60 w-75 rounded-xl border-2 border-blue-500 p-5":"hidden"}
              ...
              >
                ...
                <div className="w-68 h-20 flex justify-between mt-1">
                  <div>
                    <h1 className="text-lg font-semibold text-gray-300 mt-4">
                      {job.title}
                    </h1>
          ...
          <button
            onClick={() => {
              if (counter1 < jobData.length-4) setCounter1(counter1 + 1);
            }}
          >
...
export default HeroSectionJobs;
