...
const Jobs2 = () => {
  ...
  const submitHandler = async (event) => {
    try {
      ...
      formData.append("modeOfJob", modeOfJob);
      ...
      const response = await fetch("http://localhost:3200/add-job-posting",{
         method:"POST",
         body:formData,
         credentials:"include"
      });
      ...
      if(data.success){
         alert("Job Posting Posted Successfully");
         navigate("/home");  
         return;
      }
      ...
      >
        ...
        <div
          className={
            hostSwitch == "on"
              ? button == "on"
                ? profileTab ? "relative bottom-194 opacity-25 z-10":"relative bottom-110 opacity-25 z-10"
                : profileTab ? "relative bottom-144 opacity-25 z-10":"relative bottom-60 opacity-25 z-10"
              : button == "on"
                ? profileTab ? "relative bottom-134 opacity-100 z-10":"relative bottom-50 opacity-25 z-10"
                : profileTab ? "relative bottom-84 opacity-100 z-10":"opacity-100 z-10"
          }
        >
          ...
          <div className="ml-15 mt-10 z-20">
            <form className="flex gap-y-10 flex-wrap" onSubmit={submitHandler}>
              ...
              <div>
                <label htmlFor="ctc" className="text-md font-semibold mr-5">
                  CTC (Annual)
                </label>
                <input
                  type="text"
